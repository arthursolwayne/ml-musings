...
<a id="ref-2"></a>2. [**^**](#facts) Zheng and Meister (2024). "[The unbearable slowness of being: Why do we live at 10 bits/s?](https://pubmed.ncbi.nlm.nih.gov/39694032/)". *Neuron*.
...
<a id="ref-5"></a>5. [**^**](#facts) Ren, Takahashi and Tanaka-Ishii (2019). "[Entropy Rate Estimation for English](https://pmc.ncbi.nlm.nih.gov/articles/PMC7514546/)". *Entropy*.
...
<a id="ref-7"></a>7. [**^**](#facts) Chekaf, Cowan and Mathy (2016). "[Chunk formation in immediate memory](https://pmc.ncbi.nlm.nih.gov/articles/PMC4983232/)". *Cognition*.
...
<a id="ref-e1"></a>e1. [**^**](#facts) Arthur and Claude (2025). "[Bits Per Chunk](fermi_superforecasts/bits_per_chunk.md)".

<a id="ref-e2"></a>e2. [**^**](#facts) Arthur and Claude (2025). "[Working Memory Bits](fermi_superforecasts/working_memory_bits.md)".

<a id="ref-e3"></a>e3. [**^**](#facts) Arthur and Claude (2025). "[LLM Verbatim Recall](fermi_superforecasts/llm_verbatim_recall.md)".
